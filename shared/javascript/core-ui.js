...
!function(t, e) {
    ...
    o(function(t) {
        ...
        (t.exports = function(t, e, n, r) {
            ...
            t[e] !== n && (i && (g(n, o) || L(n, o, t[e] ? "" + t[e] : a.join(String(e)))),
            t === v ? t[e] = n : r ? t[e] ? t[e] = n : L(t, e, n) : (delete t[e],
            L(t, e, n)))
        }
    ...
    C("split", 2, function(i, o, a) {
        ...
        if ("c" == "abbc"[t](/(b)*/)[1] || 4 != "test"[t](/(?:)/, -1)[g] || 2 != "ab"[t](/(?:ab)*/)[g] || 4 != "."[t](/(.?)(.?)/)[g] || 1 < "."[t](/()()/)[g] || ""[t](/.?/)[g]) {
            ...
            a = function(t, e) {
                ...
                if (!p(t))
                    return h.call(n, t, e);
                var r, i, o, a, u, c = [], s = (t.ignoreCase ? "i" : "") + (t.multiline ? "m" : "") + (t.unicode ? "u" : "") + (t.sticky ? "y" : ""), l = 0, f = void 0 === e ? 4294967295 : e >>> 0, d = new RegExp(t.source,s + "g");
                for (m || (r = new RegExp("^" + d.source + "$(?!\\s)",s)); (i = d.exec(n)) && !(l < (o = i.index + i[0][g]) && (c.push(n.slice(l, i.index)),
                !m && 1 < i[g] && i[0].replace(r, function() {
                ...
                c[g] >= f)); )
                    d[y] === i.index && d[y]++;
                return l === n[g] ? !a && d.test("") || c.push("") : c.push(n.slice(l)),
                c[g] > f ? c.slice(0, f) : c
            }
        } else
            "0"[t](void 0, 0)[g] && (a = function(t, e) {
    ...
    var D = function(t) {
      ...
      , U = "prototype"
      , F = function(t, e, n) {
        var r, i, o, a, u = t & F.F, c = t & F.G, s = t & F.S, l = t & F.P, f = t & F.B, d = c ? v : s ? v[e] || (v[e] = {}) : (v[e] || {})[U], p = c ? w : w[e] || (w[e] = {}), h = p[U] || (p[U] = {});
        for (r in c && (n = e),
        n)
            o = ((i = !u && d && void 0 !== d[r]) ? d : n)[r],
            a = f && i ? Q(o, v) : l && "function" == typeof o ? Q(Function.call, o) : o,
            d && O(d, r, o, t & F.U),
            p[r] != o && L(p, r, a),
            l && h[r] != o && (h[r] = o)
    };
    ...
    function(t, e, n) {
        var r, i, o, a = G(t), u = J(a.length), c = (i = u,
        (r = B(r = n)) < 0 ? $(r + i, 0) : W(r, i));
        if (q && e != e) {
            for (; c < u; )
                if ((o = a[c++]) != o)
                    return !0
    ...
    ), tt = X("IE_PROTO"), et = "constructor,hasOwnProperty,isPrototypeOf,propertyIsEnumerable,toLocaleString,toString,valueOf".split(","), nt = Object.keys || function(t) {
        return function(t, e) {
            var n, r = G(t), i = 0, o = [];
            for (n in r)
                n != tt && g(r, n) && o.push(n);
            for (; e.length > i; )
                g(r, n = e[i++]) && (~Z(o, n) || o.push(n));
            return o
        }(t, et)
    }
    ...
    , it = v.document, ot = it && it.documentElement, at = X("IE_PROTO"), ut = function() {}, ct = "prototype", st = function() {
    ...
    var vt = function(t) {
      ...
      , mt = Object.getPrototypeOf || function(t) {
        return t = vt(t),
        g(t, gt) ? t[gt] : "function" == typeof t.constructor && t instanceof t.constructor ? t.constructor.prototype : t instanceof Object ? yt : null
    }
      , bt = I("iterator")
      ...
      , Lt = function(t, e, n, r, i, o, a) {
        ...
        }, h = e + " Iterator", v = i == St, g = !1, y = t.prototype, m = y[bt] || y["@@iterator"] || i && y[i], b = m || p(i), w = i ? v ? p("entries") : b : void 0, S = "Array" == e && y.entries || m;
        if (S && (d = mt(S.call(new t))) !== Object.prototype && d.next && (pt(d, h, !0),
        "function" != typeof d[bt] && L(d, bt, _t)),
        v && m && m.name !== St && (g = !0,
        b = function() {
            return m.call(this)
        }
      ...
      , Ot = Lt(Array, "Array", function(t, e) {
        ...
        M(1)) : M(0, "keys" == e ? n : "values" == e ? t[n] : [n, t[n]])
    }, "values");
    R.Arguments = R.Array,
    D("keys"),
    D("values"),
    ...
    for (var Tt = I("iterator"), It = I("toStringTag"), Ct = R.Array, kt = {
        ...
        if (Mt && (Mt[Tt] || L(Mt, Tt, Ct),
        Mt[It] || L(Mt, It, At),
        R[At] = Ct,
        Pt))
            for (xt in Ot)
                Mt[xt] || O(Mt, xt, Ot[xt], !0)
    }
    !function() {
    ...
    var Rt = {
      ...
      , Qt = !Gt || u(function() {
        ...
        for (var n = vt(t), r = arguments.length, i = 1, o = Rt.f, a = Nt.f; i < r; )
            for (var u, c = N(arguments[i++]), s = o ? nt(c).concat(o(c)) : nt(c), l = s.length, f = 0; f < l; )
    ...
    V(V.S + V.F * !function(t, e) {
        ...
        from: function(t) {
            var e, n, r, i, o, a = vt(t), u = "function" == typeof this ? this : Array, c = arguments.length, s = 1 < c ? arguments[1] : void 0, l = void 0 !== s, f = 0, d = $t(a);
            if (l && (s = Q(s, 2 < c ? arguments[2] : void 0, 2)),
            null != d && (u != Array || (void 0 === (o = d) || R.Array !== o && Kt[Vt] !== o)))
                for (i = d.call(a),
                n = new u; !(r = i.next()).done; f++)
    ...
    var te, ee, ne, re, ie, oe, ae, ue, ce, se, le, fe, de, pe, he, ve, ge, ye, me, be, we, Se, _e, Le, Oe, Te, Ie, Ce, ke, Ee, je, xe, Ae = (ee = "ajaxLoad",
    ne = "coreui.ajaxLoad",
    re = (te = e).fn[ee],
    ie = "active",
    oe = "open",
    ...
    pe = function() {
        ...
        t.setUpUrl = function(t) {
            ...
            te(ce + ':has(a[href="' + t.replace(/^\//, "").split("?")[0] + '"])').addClass(oe),
            te(le + ' a[href="' + t.replace(/^\//, "").split("?")[0] + '"]').addClass(ie),
            this.loadPage(t)
        }
        ,
        ...
        t._addEventListeners = function() {
            ...
            te(document).on(ue, se + '[href!="#"]', function(t) {
                t.preventDefault(),
                t.stopPropagation(),
                "_top" === t.currentTarget.target ? e.loadTop(t.currentTarget.href) : "_blank" === t.currentTarget.target ? e.loadBlank(t.currentTarget.href) : e.setUpUrl(t.currentTarget.getAttribute("href"))
            })
        }
        ,
    ...
    Se = ["aside-menu-show", "aside-menu-sm-show", "aside-menu-md-show", "aside-menu-lg-show", "aside-menu-xl-show"],
    _e = function() {
        function n(t) {
            this._element = t,
            this._addEventListeners()
    ...
    je = 5 == Le || Ee,
    xe = Oe || function(t, e) {
        return Me(n = t) && ("function" != typeof (r = n.constructor) || r !== Array && !Me(r.prototype) || (r = void 0),
    ...
    var Ue, Fe, qe, Ve, Ke, He, Be, ze, Je, $e, We, Ye, Xe, Ze, tn, en, nn, rn, on, an, un, cn, sn, ln, fn = function(t, e) {
        ...
        t.match(/^--.*/i) && Boolean(document.documentMode) && 10 <= document.documentMode) ? n = function() {
    ...
    cn = ".sidebar-toggler",
    sn = ["sidebar-show", "sidebar-sm-show", "sidebar-md-show", "sidebar-lg-show", "sidebar-xl-show"],
    ln = function() {
        function n(t) {
            this._element = t,
            this.mobile = !1,
        ...
        return t.perfectScrollbar = function(t) {
            ...
            if ("undefined" != typeof r) {
                ...
                t === $e.TOGGLE && (n.contains(Je) ? this.destroyScrollbar() : (this.destroyScrollbar(),
                this.ps = this.makeScrollbar())),
                t !== $e.UPDATE || n.contains(Je) || setTimeout(function() {
                    e.destroyScrollbar(),
                    e.ps = e.makeScrollbar()
                }, Ke)
            }
        }
        ,
        ...
        t.setActiveLink = function() {
            Ue(on).find(en).each(function(t, e) {
                var n, r = e;
                "#" === (n = r.classList.contains(nn) ? String(window.location) : String(window.location).split("?")[0]).substr(n.length - 1) && (n = n.slice(0, -1)),
                Ue(Ue(r))[0].href === n && Ue(r).addClass(He).parents(Ze).add(r).each(function(t, e) {
        ...
        t._clickOutListener = function(t) {
            this._element.contains(t.target) || (t.preventDefault(),
            t.stopPropagation(),
        ...
        t._addEventListeners = function() {
            ...
            Ue(document).on($e.CLICK, Ye, function(t) {
                t.preventDefault(),
                t.stopPropagation(),
                Ue(We).toggleClass(Be)
            }),
            Ue(document).on($e.CLICK, Xe, function(t) {
                t.preventDefault(),
                t.stopPropagation();
                var e = t.target;
                Ue(e).parent().toggleClass(ze),
    ...
    window.hexToRgb = function(t) {
        ...
        return r = 7 === t.length ? (e = parseInt(t.substring(1, 3), 16),
        n = parseInt(t.substring(3, 5), 16),
        parseInt(t.substring(5, 7), 16)) : (e = parseInt(t.substring(1, 2), 16),
    ...
    window.hexToRgba = function(t, e) {
        ...
        if (!t.match(/^#(?:[0-9a-f]{3}){1,2}$/i))
            throw new Error(t + " is not a valid hex color");
        return i = 7 === t.length ? (n = parseInt(t.substring(1, 3), 16),
        r = parseInt(t.substring(3, 5), 16),
        parseInt(t.substring(5, 7), 16)) : (n = parseInt(t.substring(1, 2), 16),
    ...
    window.rgbToHex = function(t) {
        ...
        if (!e)
            throw new Error(t + " is not a valid rgb color");
